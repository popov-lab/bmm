...
that would improve the usability of the pacakge, feel free to create an [issue](https://github.com/popov-lab/bmm/issues). 
...
as well as the [Contributor Guidelines](https://github.com/popov-lab/bmm/blob/develop/.github/CONTRIBUTING.md). 
