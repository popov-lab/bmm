...
`bmmodel`[^1]. The `peffects` part specifies all effects that are
...
[`bmm()`](https://venpopov.com/bmm/reference/bmm.md) function. There are
two ways to set up formulas, both work equally easy and well:
...
(e.g. [`?sdm`](https://venpopov.com/bmm/reference/sdm.md)).
...
[^1]: You can always find information on the parameters of a `bmmodel`
    by calling the help for the model you want to fit: `?bmmodel`
