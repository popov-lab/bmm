...
[`bmm()`](https://venpopov.com/bmm/reference/bmm.md) function. First,
let’s specify the model formula. We want `c` and `kappa` to vary over
conditions. The first two lines of the formula specify how the
...
[`sdmSimple()`](https://venpopov.com/bmm/reference/sdm.md), and we
