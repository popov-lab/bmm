...
|----|----|----|----|
| EZDM | Aggregated stats | [`ezdm_summary_stats()`](https://venpopov.com/bmm/reference/ezdm_summary_stats.md) | Required during aggregation |
| DDM / csWald | Trial-level | [`flag_contaminant_rts()`](https://venpopov.com/bmm/reference/flag_contaminant_rts.md) | Optional preprocessing |
