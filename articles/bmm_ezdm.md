...
using the [`rezdm()`](https://venpopov.com/bmm/reference/ezdm_dist.md)
...
[`bmmformula()`](https://venpopov.com/bmm/reference/bmmformula.md) (or
[`bmf()`](https://venpopov.com/bmm/reference/bmmformula.md)). For this
example, we want to estimate separate drift rates for each condition
while keeping boundary and non-decision time constant:
