...
inside [`bmm()`](https://venpopov.com/bmm/reference/bmm.md) to convert
the `bmmformula` into a `brmsformula` based on information in the model
object. It will call the appropriate bmf2bf.\\ methods based on the
classes defined in the model\_\\ function.
