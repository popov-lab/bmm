...
The plot shows observed response proportions (black points and dashed line) against the posterior predictive mean (blue line) and 95% credible interval (blue ribbon) for each response category, faceted by experimental condition. If the model fits the data well, the observed proportions should fall within the credible band.
