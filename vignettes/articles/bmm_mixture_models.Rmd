...
The two-parameter mixture model [@Zhang_Luck_2008] and the three-parameter mixture model [@Bays_Catalao_Husain_2009] are measurement models for continuous reproduction tasks in the visual working memory domain (for details on the task, see [the online article](https://venpopov.com/bmm/articles/bmm_vwm_crt.html). As other measurement models for continuous reproduction tasks, their goal is to model the distribution of angular response errors.
