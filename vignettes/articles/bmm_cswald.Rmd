...
Alternatively, we can simulate data from a diffusion process using
`rcswald()`, which internally uses `rtdists::rdiffusion()` to generate
theoretically consistent samples:
