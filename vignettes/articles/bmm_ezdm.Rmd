...
at zero drift and higher away from it, which inflates the sampling variance of
$s^2$ by a factor of roughly four, and the skew makes the mean and the variance
correlate at about 0.65. A likelihood that ignores both treats each cell as more
...
summaries split by boundary — and why a cell in which one boundary was reached
only once or twice contributes through the response counts alone.
