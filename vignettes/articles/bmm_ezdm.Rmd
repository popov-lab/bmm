...
diffusion decision times are conspicuously right-skewed. Their kurtosis is 8.8
at zero drift and falls towards 3 as drift grows. This inflates the sampling
variance of $s^2$ by a factor of about 3.8 (3.7 to 3.9 at accuracies between .60
and .95, less at higher accuracy, and up to 5.7 with an asymmetric starting
point), and the skew makes the mean and the variance correlate at about 0.7. A likelihood that ignores both treats each cell as more
