...
with 100 trials per cell and 3.5 to 3.6 with 10 (less at accuracies above .95, and
more with an asymmetric starting point: up to 5.7 for a relative starting point
between .3 and .7), and the skew makes the mean and the variance correlate at about 0.7. A likelihood that ignores both treats each cell as more
