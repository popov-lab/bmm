...
Alternatively, you can install the development version of the package or
a specific version of the package from GitHub:
...
[`bmm()`](https://venpopov.com/bmm/reference/bmm.md) function. This
function takes:
...
![](reference/figures/README-bmmLogic.png)
...
[`bmm()`](https://venpopov.com/bmm/reference/bmm.md) function will then
call the appropriate functions for the specified model and will perform
several steps:

1.  Configure the sampler (e.g., set up prallelization & additional
    settings)
2.  Check the information passed to the
    [`bmm()`](https://venpopov.com/bmm/reference/bmm.md) function:
...
![](reference/figures/README-fitModel_process.png)
