...
- [`bmm()`](https://venpopov.com/bmm/reference/bmm.md) now warns when a
  predictor in the formula shares its name with both a predicted
...
- Add the **Diffusion Decision Model** (`ddm`) for speeded
  ...
  [`dddm()`](https://venpopov.com/bmm/reference/ddm_dist.md) and
...
- Add the **EZ-Diffusion Model** (`ezdm`) for speeded decision-making
  ...
  [`dezdm()`](https://venpopov.com/bmm/reference/ezdm_dist.md) and
...
- Add the **Censored Shifted Wald Model** (`cswald`) for choice reaction
  ...
  [`qcswald()`](https://venpopov.com/bmm/reference/cswald_dist.md), and
...
- New **pp_check()** method for multinomial models (e.g., `m3`). Since
  ...
  [`pp_check()`](https://venpopov.com/bmm/reference/pp_check.bmmfit.md)
  delegates to
  [`brms::pp_check()`](https://mc-stan.org/bayesplot/reference/pp_check.html)
...
- vectorize [`k2sd()`](https://venpopov.com/bmm/reference/k2sd.md)
